!function (a) {
    ...
    var f = "rating-clear", g = "." + f, h = "hidden", i = {min: 1, max: 3, "empty-value": 0, iconLib: "glyphicon", activeIcon: "glyphicon-star", inactiveIcon: "glyphicon-star-empty", clearable: !1, clearableIcon: "glyphicon-remove", clearableRemain: !1, inline: !1, readonly: !1, copyClasses: !0}, j = function (a, b) {
        var c = this.$input = a;
        this.options = d(c, b);
